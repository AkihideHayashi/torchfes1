...
def main():
    ...
    plumed.readInputLine("metad: METAD ARG=p.x PACE=100 HEIGHT=0.01 SIGMA=0.1 GRID_MIN=-5.0 GRID_MAX=5.0 BIASFACTOR=2.0 CALC_RCT GRID_WFILE=HILLS GRID_RFILE=HILLS GRID_WSTRIDE=10")
